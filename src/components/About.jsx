        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-between space-y-8 lg:space-y-0 lg:space-x-12">
          ...
          >
            <motion.h2
              ...
              animate={
                inView ? staggeredTextAnimationProps(0).animate : "hidden"
              }
            ...
            >
              El objetivo de Consultora Permol es brindar soluciones
              personalizadas para cada cliente, garantizando una administración
              eficiente e integral de los Recursos Humanos, impulsando el
              crecimiento y éxito continuo de tu negocio.
            </motion.p>
          </motion.div>
        </div>
      </div>
